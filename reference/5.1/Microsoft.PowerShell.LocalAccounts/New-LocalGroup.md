...
## DESCRIPTION
Командлет **New-LocalGroup** создает локальную группу безопасности в диспетчере учетных записей безопасности.
...
### Пример 1. Создание группы безопасности

```
PS C:\> New-LocalGroup -Name "SecurityGroup04"
```

Эта команда создает группу с именем SecurityGroup04.
...
Этот командлет возвращает группу безопасности.
