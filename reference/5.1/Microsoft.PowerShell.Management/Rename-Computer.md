...
Указывает, какой протокол следует использовать для переименования компьютера.
Допустимые значения для этого параметра: WSMan и DCOM.
Значение по умолчанию — DCOM.
