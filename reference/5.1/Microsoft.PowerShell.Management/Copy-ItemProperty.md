...
Указывает элемент или элементы, исключаемые этим командлетом, в виде массива строк.
...
При использовании параметра **PassThru** этот командлет создает объект **PsCustomObject** , представляющий скопированное свойство Item.
