...
- Без **ограничений** . загружает все файлы конфигурации и выполняет все скрипты. Перед запуском неподписанного скрипта, загруженного из Интернета, программа просит ввести разрешение.
