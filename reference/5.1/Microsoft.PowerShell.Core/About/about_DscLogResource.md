...
Краткое описание ресурса журнала настройки требуемого состояния (DSC) PowerShell. ПОДРОБНОЕ ОПИСАНИЕ

## <a name="long-description"></a>ПОДРОБНОЕ ОПИСАНИЕ

## <a name="how-to-use-the-dsc-log-resource"></a>ИСПОЛЬЗОВАНИЕ РЕСУРСА ЖУРНАЛА DSC
