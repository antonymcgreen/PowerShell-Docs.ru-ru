...
- [ConvertFrom-String](xref:Microsoft.PowerShell.Utility.ConvertFrom-String): строится на основе [FlashExtract](https://www.microsoft.com/research/publication/flashextract-framework-data-extraction-examples), `ConvertFrom-String` создает пользовательские объекты из структурированных строковых данных.
  В этом разделе будет продемонстрирован и рассмотрен каждый из этих методов.
