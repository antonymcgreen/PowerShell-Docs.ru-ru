...
- Расположение **ALLUSERS** находится `$env:PROGRAMFILES\WindowsPowerShell\Modules` в Windows.
...
Дополнительные сведения об оснастках PowerShell см. в разделе [about_PSSnapins](about_PSSnapins.md).
...
Можно также использовать параметр групповая политика, включить ведение журнала модуля, чтобы включить ведение журнала модуля во всех сеансах PowerShell. Дополнительные сведения см. в разделе [about_EventLogs](about_EventLogs.md) и [about_Group_Policy_Settings](about_Group_Policy_Settings.md).
