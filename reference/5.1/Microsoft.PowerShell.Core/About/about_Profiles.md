...
|Текущий пользователь, все узлы   |$Home \\ [мои] документы \\ WindowsPowerShell \\Profile.ps1 |
|Текущий пользователь, текущий узел|$Home \\ [мои] документы \\ WindowsPowerShell\\<br>Microsoft.PowerShell_profile.ps1 |
...
Кроме того, другие программы, на которых размещается PowerShell, могут поддерживать собственные профили. Например, интегрированная среда сценариев (ISE) PowerShell поддерживает следующие профили конкретных узлов.

|Описание               | Путь                                       |
|--------------------------|--------------------------------------------|
|Все пользователи, текущий узел   |$PSHOME \\Microsoft.PowerShellISE_profile.ps1|
|Текущий пользователь, текущий узел|$Home \\ [мои] документы \\ WindowsPowerShell\\<br>Microsoft.PowerShellISE_profile.ps1 |
