...
---
# <a name="about-logging"></a>Сведения о ведении журнала
...
Журналы PowerShell можно просмотреть с помощью Просмотр событий Windows. Журнал событий находится в группе Журналы приложений и служб и называется `Microsoft-Windows-PowerShell` . Связанным поставщиком ETW `GUID` является `{A0C1853B-5C40-4B15-8766-3CF1C58F985A}` .
