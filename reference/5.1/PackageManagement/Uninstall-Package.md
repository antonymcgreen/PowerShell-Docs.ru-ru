...
Указывает, что этот командлет удаляет компоненты системы.
...
Указывает, что этот командлет удаляет пакет с помощью установщик Windows.
