...
> [!IMPORTANT]
> Проблема с этим параметром в Windows PowerShell исправлена в PowerShell 6,2 и более поздних версиях. При использовании аргумента **GetEnumerator** и явном использовании параметра **InputObject** команда все равно перечислена. Чтобы обойти это, передайте аргументы **InputObject** в расположение.
