...
Указывает свойства, которые этот командлет исключает из операции. Разрешено использовать подстановочные знаки. Этот параметр действует, только если команда также включает в себя параметр **Property** .
