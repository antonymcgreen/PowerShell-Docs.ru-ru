...
> [!IMPORTANT]
> В более новых версиях PowerShell добавляются дополнительные описатели **UFormat** . Например, `%F` был добавлен в powershell 6,2, поэтому он недоступен в Windows powershell 5,1 или более ранней версии. Это следует учитывать при использовании описателей **UFormat** в сценариях, предназначенных для выполнения в нескольких версиях PowerShell.
