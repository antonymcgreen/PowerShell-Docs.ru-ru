...
`Tee-Object` использует кодировку Юникод (UTF-16LE) при записи в файлы. Если требуется другая кодировка, используйте `Out-File` командлет с параметром **Encoding** .
