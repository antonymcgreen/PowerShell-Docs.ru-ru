...
`New-ModuleManifest` создает файлы манифеста модуля ( `.psd1` ), закодированные следующим образом:

- PowerShell 6,0, работающий в Windows, использует **UTF16**.
- PowerShell 6,0, работающий на платформах, отличных от Windows, использует **UTF8NoBOM**.
- PowerShell 6,1 и более поздние версии, работающие на платформах Windows и не на платформе Windows, используют **UTF8NoBOM**.
