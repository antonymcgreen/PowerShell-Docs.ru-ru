...
## <a name="using-remote-variables"></a><span data-ttu-id="b2ee2-112">Использование удаленных переменных</span><span class="sxs-lookup"><span data-stu-id="b2ee2-112">Using remote variables</span></span>
