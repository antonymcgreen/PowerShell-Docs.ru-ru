...
- Каждый набор параметров должен иметь уникальное сочетание параметров. По возможности, по крайней мере один из уникальных параметров должен быть обязательным параметром.
