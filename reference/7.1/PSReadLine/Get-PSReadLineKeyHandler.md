...
Если параметр не указан, возвращает текущие привязанные функции ключа для модуля PSReadLine.

Если указан параметр **аккорд** , командлет возвращает определенные связанные ключи.
...
### Пример 3. получение специальных привязок к ключам

Эта команда возвращает только привязки для указанных ключей.
...
Возвращать только функции, связанные с конкретными ключами или последовательностями.
