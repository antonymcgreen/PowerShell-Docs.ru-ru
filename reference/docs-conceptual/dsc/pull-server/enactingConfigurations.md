...
![Режим принудительной отправки](../images/pushModel.png "Принцип работы режима принудительной отправки")
...
![Режим опроса](../images/pullModel.png "Принцип работы режима запросов")
