...
- Если вы указали значение **ReadOnly** для свойства **Attributes** вместе с **DestinationPath**, **Ensure** и **Present** создадут указанный путь, а **Contents** зададут содержимое файла. Задание **Ensure** **Absent** приведет к пропуску свойства **Attributes** полностью и удалит любой файл по указанному пути.
