...
Используя [CentOS 7][], скачайте пакет RPM
...
`snapd` — это утилита для запуска Snap-пакетов.
...
* `$PSHOME` — это `/opt/microsoft/powershell/6.2.0/`
