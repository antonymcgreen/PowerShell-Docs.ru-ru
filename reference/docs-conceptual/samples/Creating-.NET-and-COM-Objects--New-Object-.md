...
#### <a name="storing-objects-in-variables"></a><span data-ttu-id="fa92d-123">Сохранение объектов в переменных</span><span class="sxs-lookup"><span data-stu-id="fa92d-123">Storing Objects in Variables</span></span>
