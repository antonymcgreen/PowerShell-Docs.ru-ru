...
Объекты сервера сценариев Windows можно создать, указав следующие программные идентификаторы: **WScript.Shell**, **WScript.Network**, **Scripting.Dictionary** и **Scripting.FileSystemObject**. Эти объекты создаются следующими командами:
