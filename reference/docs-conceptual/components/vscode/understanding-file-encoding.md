...
2. При выполнении скрипта непосредственно в интегрированной консоли, они все считываемые из файла PowerShell непосредственно. Если кодировка PowerShell отличается от его VSCode, что-нибудь может пойти не так здесь.
