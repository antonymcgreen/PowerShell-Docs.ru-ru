...
В этом примере показано, как вставить параметердескриптионс в `Param` инструкцию функции или скрипта. Этот формат наиболее удобен, если описания параметров являются краткими.
