...
|Язык|Раздел|
|--------------|-----------|
|C#|[Пример кода StopProc04 (C#)](./stopprocesssample04-csharp-sample-code.md)|
|VB.NET|[Пример кода StopProc04 (VB.NET)](./stopprocesssample04-vb-net-sample-code.md)|
