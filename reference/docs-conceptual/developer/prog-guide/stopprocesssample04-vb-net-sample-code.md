...
ms.date: 09/13/2016
ms.topic: reference
title: Пример кода StopProcessSample04 (VB.NET)
description: Пример кода StopProcessSample04 (VB.NET)
ms.openlocfilehash: 6eb2f8de83c17fa000cddf84ccc030b4fb39ff73
ms.sourcegitcommit: ba7315a496986451cfc1296b659d73ea2373d3f0
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 12/10/2020
ms.locfileid: "92653805"
---
# <a name="stopprocesssample04-vbnet-sample-code"></a><span data-ttu-id="c9c43-103">Пример кода StopProcessSample04 (VB.NET)</span><span class="sxs-lookup"><span data-stu-id="c9c43-103">StopProcessSample04 (VB.NET) Sample Code</span></span>

<span data-ttu-id="c9c43-104">Ниже приведен полный пример кода VB.NET для командлета StopProc04 Sample.</span><span class="sxs-lookup"><span data-stu-id="c9c43-104">Here is the complete VB.NET sample code for the StopProc04 sample cmdlet.</span></span> <span data-ttu-id="c9c43-105">Это код `Stop-Process` командлета, описанный в разделе [Добавление наборов параметров в командлет](../cmdlet/adding-parameter-sets-to-a-cmdlet.md).</span><span class="sxs-lookup"><span data-stu-id="c9c43-105">This is the code for the `Stop-Process` cmdlet described in [Adding Parameter Sets to a Cmdlet](../cmdlet/adding-parameter-sets-to-a-cmdlet.md).</span></span> <span data-ttu-id="c9c43-106">`Stop-Process`Командлет предназначен для того, чтобы прерывать процессы, полученные с помощью командлета Get-Proc (описывается в разделе [Создание первого командлета](../cmdlet/creating-a-cmdlet-without-parameters.md)).</span><span class="sxs-lookup"><span data-stu-id="c9c43-106">The `Stop-Process` cmdlet is designed to stop processes that are retrieved using the Get-Proc cmdlet (described in [Creating Your First Cmdlet](../cmdlet/creating-a-cmdlet-without-parameters.md)).</span></span>

> [!NOTE]
> <span data-ttu-id="c9c43-107">Вы можете скачать исходный файл VB.NET (stopprocesssample04. vb) для этого командлета Stop-Proc, используя пакет средств разработки программного обеспечения Microsoft Windows для компонентов среды выполнения Windows Vista и .NET Framework 3,0.</span><span class="sxs-lookup"><span data-stu-id="c9c43-107">You can download the VB.NET (stopprocesssample04.vb) source file for this Stop-Proc cmdlet using the Microsoft Windows Software Development Kit for Windows Vista and .NET Framework 3.0 Runtime Components.</span></span> <span data-ttu-id="c9c43-108">Инструкции по загрузке см. в статье [Установка Windows PowerShell и Загрузка пакета SDK для Windows PowerShell](/powershell/scripting/developer/installing-the-windows-powershell-sdk).</span><span class="sxs-lookup"><span data-stu-id="c9c43-108">For download instructions, see [How to Install Windows PowerShell and Download the Windows PowerShell SDK](/powershell/scripting/developer/installing-the-windows-powershell-sdk).</span></span>
>
> <span data-ttu-id="c9c43-109">Скачанные исходные файлы доступны в **\<PowerShell Samples>** каталоге.</span><span class="sxs-lookup"><span data-stu-id="c9c43-109">The downloaded source files are available in the **\<PowerShell Samples>** directory.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="c9c43-110">См. также:</span><span class="sxs-lookup"><span data-stu-id="c9c43-110">See Also</span></span>

[<span data-ttu-id="c9c43-111">Руководство программиста по Windows PowerShell</span><span class="sxs-lookup"><span data-stu-id="c9c43-111">Windows PowerShell Programmer's Guide</span></span>](./windows-powershell-programmer-s-guide.md)

[<span data-ttu-id="c9c43-112">Пакет SDK для Windows PowerShell</span><span class="sxs-lookup"><span data-stu-id="c9c43-112">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)
