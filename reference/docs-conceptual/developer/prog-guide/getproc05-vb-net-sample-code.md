...
ms.locfileid: "72366663"
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="5d45c-102">Пример кода GetProc05 (VB.NET)</span><span class="sxs-lookup"><span data-stu-id="5d45c-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="5d45c-103">Ниже приведен полный код VB.NET для командлета GetProc05 Sample.</span><span class="sxs-lookup"><span data-stu-id="5d45c-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="5d45c-104">См. также:</span><span class="sxs-lookup"><span data-stu-id="5d45c-104">See Also</span></span>

[<span data-ttu-id="5d45c-105">Пакет SDK для Windows PowerShell</span><span class="sxs-lookup"><span data-stu-id="5d45c-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)