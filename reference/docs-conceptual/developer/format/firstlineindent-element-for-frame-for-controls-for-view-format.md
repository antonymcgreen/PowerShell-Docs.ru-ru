...
Указывает, сколько знаков первая строка данных смещается вправо. Этот элемент используется при определении элементов управления, которые могут использоваться представлением.
...
[Элемент Фирстлинехангинг для элемента управления Frame для представления (Format)](./firstlinehanging-element-for-frame-for-controls-for-view-format.md)
