...
Строки форматирования можно добавить в расширенное представление, чтобы дополнительно определить способ отображения данных. В следующем примере показано, как определить строку форматирования для значения свойства `StartTime`.
...
[Расширенное представление (GroupBy)](./wide-view-groupby.md)
