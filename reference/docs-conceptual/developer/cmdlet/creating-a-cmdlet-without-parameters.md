...
Следует выбрать конкретное существительное. Лучше использовать одноименное существительное с сокращенной версией названия продукта. Пример имени командлета этого типа — "`Get-SQLServer`".
