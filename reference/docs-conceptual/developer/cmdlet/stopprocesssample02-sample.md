...
1. Откройте Windows Internet Explorer и перейдите в каталог StopProcessSample02 в каталоге Samples.

    С установленным пакетом SDK для Windows PowerShell 2,0 перейдите в папку StopProcessSample02 Расположение по умолчанию — C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\StopProcessSample02.
...
- Запись подробных сообщений. Дополнительные сведения о методе, используемом для записи подробных сообщений, см. в разделе [System. Management. Automation. командлет. вритевербосе](/dotnet/api/System.Management.Automation.Cmdlet.WriteVerbose).

- Запись сообщений об ошибках. Дополнительные сведения о методе, используемом для записи сообщений об ошибках, см. в разделе [System. Management. Automation. командлет. WriteError](/dotnet/api/System.Management.Automation.Cmdlet.WriteError).

- Запись предупреждающих сообщений. Дополнительные сведения о методе, используемом для записи предупреждающих сообщений, см. в разделе [System. Management. Automation. командлет. вритеварнинг](/dotnet/api/System.Management.Automation.Cmdlet.WriteWarning).
