...
1. С установленным пакетом SDK для Windows PowerShell 2,0 перейдите в папку StopProcessSample04 Расположение по умолчанию — C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\StopProcessSample04.
...
- Добавление параметров в наборы параметров

- Указание набора параметров по умолчанию.
