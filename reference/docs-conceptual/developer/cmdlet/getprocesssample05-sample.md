...
1. Откройте проводник Windows и перейдите в каталог GetProcessSample05 в каталоге Samples.

   С установленным пакетом SDK для Windows PowerShell 2,0 перейдите в папку GetProcessSample05 Расположение по умолчанию — C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\GetProcessSample05.
...
3. В меню **Построение** выберите команду **Построить решение**.
   ...
   Библиотека для примера будет построена в каталогах \bin или \bin\Debug по умолчанию.
...
- Указание позиций для параметров.

- Указание того, что параметры могут принимать входные данные из конвейера. Входные данные могут быть взяты из объекта или значения из свойства объекта, имя свойства которого совпадает с именем параметра.

- Объявление атрибута проверки для входных параметров.

- Обработка ошибок и исключений.

- Написание сообщений отладки.

## <a name="example"></a>Пример

В этом примере показано, как создать командлет, отображающий список указанных процессов.
