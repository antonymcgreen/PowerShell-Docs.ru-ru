...
Расширение IIS OData использует XML-файлы для определения сопоставления ресурсов. Следующая XSD-схема определяет схему, используемую для этих файлов.

## <a name="resource-mapping-file-xsd"></a>XSD-файл сопоставления ресурсов

Следующая XSD-схема определяет схему для файлов сопоставления ресурсов расширения IIS OData для управления.
