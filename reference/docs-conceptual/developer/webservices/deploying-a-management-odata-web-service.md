...
После выполнения всех действий, необходимых для создания веб-службы OData управления, необходимо развернуть ее как веб-приложение в службах IIS.
...
3. Создайте идентификатор сайта.

4. Создание и Настройка пула приложений.
...
В следующих сценариях Windows PowerShell показано, как развернуть веб-службу OData управления.
