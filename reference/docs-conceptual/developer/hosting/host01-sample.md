...
- Создание пользовательского класса узла, производного от класса [System. Management. Automation. host. PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) .

- Создание пространства выполнения, использующего пользовательский класс Host.

- Создание объекта [System. Management. Automation. PowerShell](/dotnet/api/System.Management.Automation.PowerShell) , который запускает скрипт, вызывающий Exit.
