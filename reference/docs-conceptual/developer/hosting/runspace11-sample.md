...
- Добавление функции-посредника в исходное состояние сеанса.
...
- Вызов закрытого командлета и функции прокси-сервера с помощью объекта [System. Management. Automation. PowerShell](/dotnet/api/system.management.automation.powershell) для демонстрации ограниченного пространства выполнения.

## <a name="example"></a>Пример

При этом создается прокси-команда для закрытого командлета для демонстрации ограниченного пространства выполнения.
