...
ms.locfileid: "87783285"
---
# <a name="host04-sample"></a><span data-ttu-id="54459-102">Пример Host04</span><span class="sxs-lookup"><span data-stu-id="54459-102">Host04 Sample</span></span>

<span data-ttu-id="54459-103">В этом примере показано, как создать консольное приложение на основе консоли, которое считывает команды из командной строки, выполняет команды и выводит результаты на консоль.</span><span class="sxs-lookup"><span data-stu-id="54459-103">This sample shows how to build an interactive console-based host application that reads commands from the command line, executes the commands, and then displays the results to the console.</span></span> <span data-ttu-id="54459-104">Это приложение также поддерживает отображение запросов, позволяющих пользователю выбрать несколько вариантов.</span><span class="sxs-lookup"><span data-stu-id="54459-104">This host application also supports displaying prompts that allow the user to specify multiple choices.</span></span>

## <a name="requirements"></a><span data-ttu-id="54459-105">Требования</span><span class="sxs-lookup"><span data-stu-id="54459-105">Requirements</span></span>

 <span data-ttu-id="54459-106">Для работы с этим образцом требуется Windows PowerShell 2,0.</span><span class="sxs-lookup"><span data-stu-id="54459-106">This sample requires Windows PowerShell 2.0.</span></span>

## <a name="demonstrates"></a><span data-ttu-id="54459-107">Что демонстрирует</span><span class="sxs-lookup"><span data-stu-id="54459-107">Demonstrates</span></span>

- <span data-ttu-id="54459-108">Создание пользовательского узла, классы которого являются производными от класса [System. Management. Automation. host. PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) , класса [System. Management. Automation. host. Пшостусеринтерфаце](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) и класса [System. Management. Automation. host. Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) .</span><span class="sxs-lookup"><span data-stu-id="54459-108">Creating a custom host whose classes derive from the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class, the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class, and the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class.</span></span>

- <span data-ttu-id="54459-109">Создание консольного приложения, использующего эти классы узлов для создания интерактивной оболочки Windows PowerShell.</span><span class="sxs-lookup"><span data-stu-id="54459-109">Building a console application that uses these host classes to build an interactive Windows PowerShell shell.</span></span>

- <span data-ttu-id="54459-110">Создание `$profile` переменной и загрузка следующих профилей.</span><span class="sxs-lookup"><span data-stu-id="54459-110">Creating a `$profile` variable and loading the following profiles.</span></span>

  - <span data-ttu-id="54459-111">текущий пользователь, текущий узел</span><span class="sxs-lookup"><span data-stu-id="54459-111">current user, current host</span></span>

  - <span data-ttu-id="54459-112">текущий пользователь, все узлы</span><span class="sxs-lookup"><span data-stu-id="54459-112">current user, all hosts</span></span>

  - <span data-ttu-id="54459-113">все пользователи, текущий узел</span><span class="sxs-lookup"><span data-stu-id="54459-113">all users, current host</span></span>

  - <span data-ttu-id="54459-114">все пользователи, все узлы</span><span class="sxs-lookup"><span data-stu-id="54459-114">all users, all hosts</span></span>

- <span data-ttu-id="54459-115">Реализуйте интерфейс [System. Management. Automation. host. ихостуисуппортсмултиплечоицеселектион](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) .</span><span class="sxs-lookup"><span data-stu-id="54459-115">Implement the [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interface.</span></span>

## <a name="example"></a><span data-ttu-id="54459-116">Пример</span><span class="sxs-lookup"><span data-stu-id="54459-116">Example</span></span>

 <span data-ttu-id="54459-117">Этот пример позволяет пользователю вводить команды в командной строке, обрабатывать эти команды, а затем выводит результаты.</span><span class="sxs-lookup"><span data-stu-id="54459-117">This example allows the user to enter commands at a command line, processes those commands, and then prints out the results.</span></span>
...
## <a name="example"></a><span data-ttu-id="54459-118">Пример</span><span class="sxs-lookup"><span data-stu-id="54459-118">Example</span></span>

 <span data-ttu-id="54459-119">Следующий код является реализацией класса [System. Management. Automation. host. PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) , который используется этим ведущим приложением.</span><span class="sxs-lookup"><span data-stu-id="54459-119">The following code is the implementation of the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class that is used by this host application.</span></span> <span data-ttu-id="54459-120">Эти элементы, которые не реализуются, вызывают исключение или не возвращают ничего.</span><span class="sxs-lookup"><span data-stu-id="54459-120">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="example"></a><span data-ttu-id="54459-121">Пример</span><span class="sxs-lookup"><span data-stu-id="54459-121">Example</span></span>

 <span data-ttu-id="54459-122">Следующий код является реализацией класса [System. Management. Automation. host. пшостусеринтерфаце](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) , который используется этим ведущим приложением.</span><span class="sxs-lookup"><span data-stu-id="54459-122">The following code is the implementation of the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class that is used by this host application.</span></span>
...
## <a name="example"></a><span data-ttu-id="54459-123">Пример</span><span class="sxs-lookup"><span data-stu-id="54459-123">Example</span></span>

 <span data-ttu-id="54459-124">Следующий код является реализацией класса [System. Management. Automation. host. Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) , который используется этим ведущим приложением.</span><span class="sxs-lookup"><span data-stu-id="54459-124">The following code is the implementation of the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class that is used by this host application.</span></span> <span data-ttu-id="54459-125">Эти элементы, которые не реализуются, вызывают исключение или не возвращают ничего.</span><span class="sxs-lookup"><span data-stu-id="54459-125">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="54459-126">См. также</span><span class="sxs-lookup"><span data-stu-id="54459-126">See Also</span></span>

 [<span data-ttu-id="54459-127">System. Management. Automation. host. PSHost</span><span class="sxs-lookup"><span data-stu-id="54459-127">System.Management.Automation.Host.PSHost</span></span>](/dotnet/api/System.Management.Automation.Host.PSHost)

 [<span data-ttu-id="54459-128">System. Management. Automation. host. Пшостусеринтерфаце</span><span class="sxs-lookup"><span data-stu-id="54459-128">System.Management.Automation.Host.Pshostuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)

 [<span data-ttu-id="54459-129">System. Management. Automation. host. Pshostrawuserinterface</span><span class="sxs-lookup"><span data-stu-id="54459-129">System.Management.Automation.Host.Pshostrawuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface)
