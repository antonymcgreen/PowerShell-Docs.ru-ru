...
Нажмите клавиши **CRTL+H** или в меню **Правка** выберите **Replace in Script** (Заменить в сценарии). Введите искомый текст и текст, которым его нужно заменить, а затем нажмите клавишу **ВВОД**.
