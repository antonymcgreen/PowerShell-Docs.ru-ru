...
|`Get-Acl`, `Set-Acl`|Недоступен.|Эти команды не распознаются. Это должно быть исправлено в последующем выпуске.|
|`Get-AuthenticodeSignature`, `Set-AuthenticodeSignature`|Недоступен.|Эти команды не распознаются. Это должно быть исправлено в последующем выпуске.|
