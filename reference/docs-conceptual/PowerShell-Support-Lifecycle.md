...
| [Snap-пакет](https://snapcraft.io/powershell)   |   См. примечание 2  |   См. примечание    |
...
| :-----: | ------------------------------ |
|   7.1   | Запланировано на середину февраля 2022 года |
...
> [!NOTE]
> Этот документ относится к поддержке PowerShell Core. Windows PowerShell (1.0–5.1) является компонентом операционной системы Windows. Компоненты получают ту же поддержку, что и их родительский продукт или платформа. Дополнительные сведения см. в разделе [Сведения о жизненном цикле продукта и служб](/lifecycle/products/).
...
## <a name="security-servicing-criteria"></a>Критерии обслуживания безопасности
...
| ------------------------ | :----------: | --------------------------------------------------------------------------------------------------------------------------------------------- |
| PowerShell 7.1 (текущая версия) |   Ноябрь 2020 г.   | На основе .NET Core 5.0 (текущая версия).                                                                                                             |
| PowerShell 7.0 (LTS)     |   Март 2020 г.   | На основе .NET Core 3.1 (LTS).                                                                                                                 |
| PowerShell 6.2           |   Март 2019 г.   |                                                                                                                                               |
| PowerShell 6.1           |   Сентябрь 2018 г.   | На основе .NET Core 2.1.                                                                                                                       |
| PowerShell 6.0           |   Январь 2018 г.   | Первый выпуск, на основе .NET Core 2.0. Устанавливается в Windows, Linux и macOS.                                                              |
