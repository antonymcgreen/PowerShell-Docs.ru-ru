...
#### <a name="storing-objects-in-variables"></a><span data-ttu-id="c71c1-123">Сохранение объектов в переменных</span><span class="sxs-lookup"><span data-stu-id="c71c1-123">Storing Objects in Variables</span></span>
