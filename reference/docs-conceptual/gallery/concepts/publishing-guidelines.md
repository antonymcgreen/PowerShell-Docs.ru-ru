---
ms.date: 06/12/2017
description: В этой статье описаны рекомендуемые шаги, гарантирующие, что пакеты, опубликованные в коллекции PowerShell, получат широкое распространение среди пользователей и будут полезны для них.
...
- Настройте [внутренний репозиторий Nuget](https://devblogs.microsoft.com/powershell/setting-up-an-internal-powershellget-repository/).
