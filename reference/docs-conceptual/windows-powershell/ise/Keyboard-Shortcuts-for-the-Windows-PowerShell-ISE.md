...
| **Все строчные**               | <kbd>CTRL</kbd>+<kbd>U</kbd>                  | Область сценариев, область команд                                                                                                                                                                                                                                                                  |
| **Все прописные**               | <kbd>CTRL</kbd>+<kbd>SHIFT</kbd>+<kbd>U</kbd> | Область сценариев, область команд                                                                                                                                                                                                                                                                  |
