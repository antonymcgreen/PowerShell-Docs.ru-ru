...
> [!NOTE]
> Начиная с PowerShell 7.0, с помощью клавиши <kbd>TAB</kbd> также можно развернуть сокращенные командлеты и функции. Например, `i-psdf<tab>` возвращает `Import-PowerShellDataFile`.
