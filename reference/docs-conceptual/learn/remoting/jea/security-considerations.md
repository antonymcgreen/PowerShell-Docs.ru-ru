...
| ---------------------------- | ----------------------------------- | ------------------------------------------------------- | -------------------- |
| Контроллер домена            | По умолчанию                             | Пользователь домена, член группы "*DOMAIN*\Domain Admins"         | Учетная запись компьютера     |
| Контроллер домена            | Группы доменов A и B               | Пользователь домена, член групп "*DOMAIN*\A", "*DOMAIN*\B"       | Учетная запись компьютера     |
| Рядовой сервер или рабочая станция | По умолчанию                             | Локальный пользователь, член группы "*BUILTIN*\Administrators"        | Учетная запись компьютера     |
