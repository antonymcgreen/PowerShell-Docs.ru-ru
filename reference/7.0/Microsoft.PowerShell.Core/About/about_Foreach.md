...
<span data-ttu-id="8f2eb-112">Ниже показан `ForEach` синтаксис.</span><span class="sxs-lookup"><span data-stu-id="8f2eb-112">The following shows the `ForEach` syntax:</span></span>
