...
|                           | 5,1 в полнофункциональных выпусках Windows.        |
|                           | Это свойство имеет значение "Core" для     |
|                           | PowerShell 6 и более поздней версии, а также PowerShell  |
|                           | PowerShell 5,1 в выпусках с ограниченным объемом памяти  |
|                           | как и в Windows Nano Server или Windows IoT.      |
| **гиткоммитид**           | Идентификаторы фиксации исходных файлов, в GitHub |
| **ОС**                    | Описание операционной системы,      |
|                           | PowerShell работает в.                     |
| **Платформа**              | Платформа, под которой работает операционная система |
|                           | в. Значение в Linux и macOS — **UNIX**. |
