...
`Wait-Job`Командлет ожидает завершения фоновых заданий PowerShell, прежде чем отобразит командную строку. При этом можно командлет может ожидать завершения одного или всех фоновых заданий либо ограничиваться максимальным временем ожидания.
