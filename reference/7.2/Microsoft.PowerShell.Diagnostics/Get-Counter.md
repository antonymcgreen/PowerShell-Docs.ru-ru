...
> [!NOTE]
> В PowerShell 7 `Get-Counter` не удается получить свойство **Description** набора счетчиков. **Описание** имеет значение `$null` .
...
В PowerShell 7 при использовании параметра **List** `Get-Counter` не может получить свойство **Description** набора счетчиков. **Описание** имеет значение `$null` .
