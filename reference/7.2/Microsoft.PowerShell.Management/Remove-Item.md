...
Этот параметр впервые появился в Windows PowerShell 3.0. Начиная с Windows PowerShell 7,2, `Remove-Item` может удалять альтернативные потоки данных из каталогов, а также файлов.
...
Запрос подтверждения перед выполнением командлета. См. сведения в следующих статьях:
