...
Этот параметр появился в PowerShell 3,0.  Начиная с PowerShell 7,2, `Add-Content` может ориентироваться на альтернативные потоки данных как в файлах, так и в каталогах.
