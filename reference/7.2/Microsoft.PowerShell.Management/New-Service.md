...
Путь также может включать аргументы для автоматической запуска службы. Пример: `'"d:\myshare\myservice.exe arg1 arg2"'`. Эти аргументы передаются в точку входа службы.
