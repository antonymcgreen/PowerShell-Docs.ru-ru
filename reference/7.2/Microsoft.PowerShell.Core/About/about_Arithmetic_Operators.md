...
PowerShell автоматически выбирает платформа .NET Framework числовой тип, который наилучшим образом выражает результат без потери точности. Пример:
