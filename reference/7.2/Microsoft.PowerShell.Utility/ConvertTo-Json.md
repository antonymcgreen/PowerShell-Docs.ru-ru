...
Начиная с PowerShell 7,2, `ConvertTo-Json` выдает предупреждение, если глубина входного объекта превышает глубину, указанную для команды. Это предотвращает нежелательные потери данных при преобразовании объектов.
...
Указывает, сколько уровней вложенных объектов включается в JSON-представление. Значение по умолчанию — 2. Начиная с PowerShell 7,2, `ConvertTo-Json` выдает предупреждение, если количество уровней во входном объекте превышает это число.
