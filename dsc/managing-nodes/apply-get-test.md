...
<span data-ttu-id="edb64-109">Компиляция этой конфигурации даст два MOF-файла.</span><span class="sxs-lookup"><span data-stu-id="edb64-109">Compiling this configuration will yield two ".mof" files.</span></span>
