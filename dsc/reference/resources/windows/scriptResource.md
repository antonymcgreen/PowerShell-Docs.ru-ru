...
### <a name="example-1-write-sample-text-using-a-script-resource"></a>Пример 1: Запись образец текста, с помощью сценария ресурса
...
### <a name="example-2-compare-version-information-using-a-script-resource"></a>Пример 2. Сравнение сведений о версии, с помощью сценария ресурса
