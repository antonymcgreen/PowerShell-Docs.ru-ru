...
5. В PowerShell ISE запустите (нажав клавишу F5) следующий сценарий конфигурации (включенный в пример папки модуля **xPSDesiredStateConfiguration** в качестве `Sample_xDscWebServiceRegistration.ps1`). Этот сценарий настраивает опрашиваемый сервер.
...
- [[MS-DSCPM]: Требуемое состояние конфигурации протокола с активным опросом сообщений](https://msdn.microsoft.com/library/dn393548.aspx)
- [[MS-DSCPM]: Требуемое состояние конфигурации протокола с активным опросом сообщений (поправки)](https://msdn.microsoft.com/library/mt612824.aspx)
