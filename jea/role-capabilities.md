...
Дополнительные сведения о модулях PowerShell см. в разделе [Основные сведения о модуле PowerShell](/powershell/developer/windows-powershell).
