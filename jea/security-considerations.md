...
Пользователям может потребоваться доступ к таким командлетам как `Get-Process` чтобы понять, какие приложения работают в системе и `Stop-Process` завершить все приложения, которые не отвечают.
