...
**WMF 5.0 заменяется WMF 5.1. Для получения поддержки пользователям WMF 5.0 необходимо выполнить обновление до WMF 5.1. Следуйте [инструкциям по установке WMF 5.1](../5.1/install-configure.md)**
