...
- Реагирование на вопросы или пожелания относительно вашего элемента
...
Примечание. Ключ API должны рассматриваться как безопасно, как имя входа и пароль.
...
- Версия — это обязательный первичный ключ, формат которого должен соответствовать рекомендациям SemVer. Дополнительные сведения см. в рекомендациях.
- Автор — это — это обязательный первичный ключ и содержит имя, которую необходимо связать с элементом.
См. в разделе, авторы и владельцы ниже.
...
- Теги — это настоятельной рекомендацией для маркировки ваш пакет, в зависимости от его совместимости с PSEditions и платформами. Дополнительные сведения см. в разделе [требованиями для публикации](../../concepts/publishing-guidelines.md#tag-your-package-with-the-compatible-pseditions-and-platforms).
