...
Следующий код показывает реализацию Windows PowerShell, описано в разделе поставщика содержимого [Создание поставщика Windows PowerShell содержимое](./creating-a-windows-powershell-content-provider.md). Этот поставщик позволяет пользователю управлять содержимым элементов в хранилище данных.
