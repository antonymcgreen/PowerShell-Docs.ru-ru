...
ms.locfileid: "58056419"
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="59b31-102">Пример кода GetProc05 (VB.NET)</span><span class="sxs-lookup"><span data-stu-id="59b31-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="59b31-103">Ниже приведен полный код для командлета образец GetProc05 VB.NET.</span><span class="sxs-lookup"><span data-stu-id="59b31-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="59b31-104">См. также</span><span class="sxs-lookup"><span data-stu-id="59b31-104">See Also</span></span>

[<span data-ttu-id="59b31-105">Пакет SDK для Windows PowerShell</span><span class="sxs-lookup"><span data-stu-id="59b31-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)