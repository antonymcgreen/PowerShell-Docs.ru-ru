...
---
# <a name="runspace02-code-samples"></a>Примеры кода Runspace02
...
|Language|Раздел|
|--------------|-----------|
|C#|[Runspace02 (C#) образец кода](./runspace02-csharp-code-sample.md)|
|VB.NET|[Runspace02 пример кода (VB.NET)](./runspace02-vb-net-code-sample.md)|
