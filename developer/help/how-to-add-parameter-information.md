...
### <a name="to-add-parameters"></a><span data-ttu-id="85a7a-109">Чтобы добавить параметры</span><span class="sxs-lookup"><span data-stu-id="85a7a-109">To Add Parameters</span></span>
