...
ms.locfileid: "71323041"
---
# <a name="role-based-authorization-configuration-schema"></a><span data-ttu-id="f67b2-102">Схема конфигурации для авторизации на основе ролей</span><span class="sxs-lookup"><span data-stu-id="f67b2-102">Role-Based Authorization Configuration Schema</span></span>

<span data-ttu-id="f67b2-103">В примере [псвсролебаседплугинс](https://go.microsoft.com/fwlink/?LinkId=243041) для настройки политики авторизации используются XML-файлы.</span><span class="sxs-lookup"><span data-stu-id="f67b2-103">The [PswsRoleBasedPlugins](https://go.microsoft.com/fwlink/?LinkId=243041) sample uses XML files to configure the authorization policy.</span></span> <span data-ttu-id="f67b2-104">Следующая XSD-схема определяет схему, используемую для этих файлов.</span><span class="sxs-lookup"><span data-stu-id="f67b2-104">The following XSD defines the schema used for these files.</span></span>
