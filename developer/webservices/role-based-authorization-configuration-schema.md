...
ms.locfileid: "56862570"
---
# <a name="role-based-authorization-configuration-schema"></a><span data-ttu-id="0f8cd-102">Схема конфигурации для авторизации на основе ролей</span><span class="sxs-lookup"><span data-stu-id="0f8cd-102">Role-Based Authorization Configuration Schema</span></span>

<span data-ttu-id="0f8cd-103">[PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) пример использует XML-файлы для настройки политики авторизации.</span><span class="sxs-lookup"><span data-stu-id="0f8cd-103">The [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) sample uses XML files to configure the authorization policy.</span></span> <span data-ttu-id="0f8cd-104">Следующие XSD определяет схему, используемую для этих файлов.</span><span class="sxs-lookup"><span data-stu-id="0f8cd-104">The following XSD defines the schema used for these files.</span></span>
