...
---
# <a name="role-based-authorization-configuration-schema"></a>Схема конфигурации для авторизации на основе ролей

В примере [псвсролебаседплугинс](https://go.microsoft.com/fwlink/?LinkId=243041) для настройки политики авторизации используются XML-файлы. Следующая XSD-схема определяет схему, используемую для этих файлов.
