...
[PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) пример использует XML-файлы для настройки политики авторизации. Следующие XSD определяет схему, используемую для этих файлов.
