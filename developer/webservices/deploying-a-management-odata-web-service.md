...
После завершения всех действий, необходимых для создания веб-службы OData для управления, необходимо развернуть его как веб-приложения в службах IIS.

## <a name="deploying-the-web-service"></a>Развертывание веб-службы

Выполните следующие действия для развертывания веб-службы OData для управления.

1. Создайте каталог для веб-приложения в разделе IIS `WWWRoot` каталога.

2. Скопируйте MOF файл схемы, файл схемы XML, библиотеки DLL, которые экспортируют [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) и [System.Management.Automation.Remoting.Pssessionconfiguration](/dotnet/api/System.Management.Automation.Remoting.PSSessionConfiguration) интерфейсы и файл web.config в каталог приложения.

3. Создать код сайта.

4. Создайте и настройте пул приложений.

5. Настройка проверки подлинности для сайта.

6. Настройка брандмауэра.

7. Запустите веб-сайт.

Следующие скрипты Windows PowerShell показано, как развернуть веб-службы OData для управления.
