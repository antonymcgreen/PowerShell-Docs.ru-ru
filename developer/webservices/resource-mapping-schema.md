...
---
# <a name="resource-mapping-schema"></a>Схема сопоставления ресурсов

Расширение IIS OData для управления использует XML-файлы для определения сопоставления ресурсов. Следующие XSD определяет схему, используемую для этих файлов.

## <a name="resource-mapping-file-xsd"></a>Файл ресурсов сопоставления XSD

Следующие XSD определяет схему для файлов сопоставления ресурсов расширение IIS OData для управления.
