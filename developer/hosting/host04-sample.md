---
title: Пример Host04 | Документация Майкрософт
ms.custom: ''
ms.date: 09/13/2016
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "62082827"
---
# <a name="host04-sample"></a><span data-ttu-id="27ea5-102">Пример Host04</span><span class="sxs-lookup"><span data-stu-id="27ea5-102">Host04 Sample</span></span>

<span data-ttu-id="27ea5-103">В этом примере показано, как сборку интерактивного консольного ведущего приложения, читает команды из командной строки, выполняет команды и затем отображает результаты на консоль.</span><span class="sxs-lookup"><span data-stu-id="27ea5-103">This sample shows how to build an interactive console-based host application that reads commands from the command line, executes the commands, and then displays the results to the console.</span></span> <span data-ttu-id="27ea5-104">Это приложение также поддерживает отображение запросов, позволяющих пользователю выбрать несколько вариантов.</span><span class="sxs-lookup"><span data-stu-id="27ea5-104">This host application also supports displaying prompts that allow the user to specify multiple choices.</span></span>

## <a name="requirements"></a><span data-ttu-id="27ea5-105">Требования</span><span class="sxs-lookup"><span data-stu-id="27ea5-105">Requirements</span></span>

 <span data-ttu-id="27ea5-106">В этом примере требуется Windows PowerShell 2.0.</span><span class="sxs-lookup"><span data-stu-id="27ea5-106">This sample requires Windows PowerShell 2.0.</span></span>

## <a name="demonstrates"></a><span data-ttu-id="27ea5-107">Демонстрирует</span><span class="sxs-lookup"><span data-stu-id="27ea5-107">Demonstrates</span></span>

- <span data-ttu-id="27ea5-108">Создание пользовательского ведущего приложения, классы являются производными от [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) класс, [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) класс и [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) класса.</span><span class="sxs-lookup"><span data-stu-id="27ea5-108">Creating a custom host whose classes derive from the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class, the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class, and the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class.</span></span>

- <span data-ttu-id="27ea5-109">Для создания консольного приложения, использует эти классы узла для создания интерактивной оболочки Windows PowerShell.</span><span class="sxs-lookup"><span data-stu-id="27ea5-109">Building a console application that uses these host classes to build an interactive Windows PowerShell shell.</span></span>

- <span data-ttu-id="27ea5-110">Создание `$profile` переменной и загрузке следующие профили.</span><span class="sxs-lookup"><span data-stu-id="27ea5-110">Creating a `$profile` variable and loading the following profiles.</span></span>

  - <span data-ttu-id="27ea5-111">текущий пользователь, текущий узел</span><span class="sxs-lookup"><span data-stu-id="27ea5-111">current user, current host</span></span>

  - <span data-ttu-id="27ea5-112">текущий пользователь, все узлы</span><span class="sxs-lookup"><span data-stu-id="27ea5-112">current user, all hosts</span></span>

  - <span data-ttu-id="27ea5-113">все пользователи, текущий узел</span><span class="sxs-lookup"><span data-stu-id="27ea5-113">all users, current host</span></span>

  - <span data-ttu-id="27ea5-114">все пользователи, все узлы</span><span class="sxs-lookup"><span data-stu-id="27ea5-114">all users, all hosts</span></span>

- <span data-ttu-id="27ea5-115">Реализуйте [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) интерфейс.</span><span class="sxs-lookup"><span data-stu-id="27ea5-115">Implement the [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interface.</span></span>

## <a name="example"></a><span data-ttu-id="27ea5-116">Пример</span><span class="sxs-lookup"><span data-stu-id="27ea5-116">Example</span></span>

 <span data-ttu-id="27ea5-117">В этом примере пользователь может вводить команды в командной строке, обрабатывает эти команды и затем выводит результаты.</span><span class="sxs-lookup"><span data-stu-id="27ea5-117">This example allows the user to enter commands at a command line, processes those commands, and then prints out the results.</span></span>
...
## <a name="example"></a><span data-ttu-id="27ea5-118">Пример</span><span class="sxs-lookup"><span data-stu-id="27ea5-118">Example</span></span>

 <span data-ttu-id="27ea5-119">Следующий код является реализацией [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) класс, используемый ведущим приложением.</span><span class="sxs-lookup"><span data-stu-id="27ea5-119">The following code is the implementation of the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class that is used by this host application.</span></span> <span data-ttu-id="27ea5-120">Те элементы, которые не реализованы исключение или не возвращать ничего.</span><span class="sxs-lookup"><span data-stu-id="27ea5-120">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="example"></a><span data-ttu-id="27ea5-121">Пример</span><span class="sxs-lookup"><span data-stu-id="27ea5-121">Example</span></span>

 <span data-ttu-id="27ea5-122">Следующий код является реализацией [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) класс, используемый ведущим приложением.</span><span class="sxs-lookup"><span data-stu-id="27ea5-122">The following code is the implementation of the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class that is used by this host application.</span></span>
...
## <a name="example"></a><span data-ttu-id="27ea5-123">Пример</span><span class="sxs-lookup"><span data-stu-id="27ea5-123">Example</span></span>

 <span data-ttu-id="27ea5-124">Следующий код является реализацией [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) класс, используемый ведущим приложением.</span><span class="sxs-lookup"><span data-stu-id="27ea5-124">The following code is the implementation of the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class that is used by this host application.</span></span> <span data-ttu-id="27ea5-125">Те элементы, которые не реализованы исключение или не возвращать ничего.</span><span class="sxs-lookup"><span data-stu-id="27ea5-125">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="27ea5-126">См. также</span><span class="sxs-lookup"><span data-stu-id="27ea5-126">See Also</span></span>

 [<span data-ttu-id="27ea5-127">System.Management.Automation.Host.PSHost</span><span class="sxs-lookup"><span data-stu-id="27ea5-127">System.Management.Automation.Host.PSHost</span></span>](/dotnet/api/System.Management.Automation.Host.PSHost)

 [<span data-ttu-id="27ea5-128">System.Management.Automation.Host.Pshostuserinterface</span><span class="sxs-lookup"><span data-stu-id="27ea5-128">System.Management.Automation.Host.Pshostuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)

 [<span data-ttu-id="27ea5-129">System.Management.Automation.Host.Pshostrawuserinterface</span><span class="sxs-lookup"><span data-stu-id="27ea5-129">System.Management.Automation.Host.Pshostrawuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface)
