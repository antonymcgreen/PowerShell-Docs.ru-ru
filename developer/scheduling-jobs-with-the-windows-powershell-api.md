...
Затем создайте ScheduledJobInvicationInfo и SheduledJobDefinition объектов, чтобы запустить задание. В следующем коде показано это.
