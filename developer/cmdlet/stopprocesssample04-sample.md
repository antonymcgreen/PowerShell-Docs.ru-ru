...
В этом примере показано, как написать командлет, который объявляет наборов параметров, указывает параметр по умолчанию значение и может принимать входной объект. Этот командлет аналогичен `Stop-Process` командлет, предоставляемые Windows PowerShell 2.0.

### <a name="how-to-build-the-sample-by-using-visual-studio"></a>Как построить образец с помощью Visual Studio.

1. С помощью Windows PowerShell 2.0 установлен пакет SDK перейдите к папке StopProcessSample04. Расположение по умолчанию — C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\StopProcessSample04.
...
- Добавление параметра, который принимает входной объект.

- Добавление параметров для наборов параметров

- Задание параметра по умолчанию набора данных.

## <a name="example"></a>Пример

Следующий код показывает реализацию командлета Stop-Proc объявить наборы параметров, указывает параметр по умолчанию значение и может принимать входной объект.

В этом примере показано входной объект, как объявить наборы параметров и способы указания параметра по умолчанию, настроенный для использования.
