...
В этом примере показано, командлет Get-Proc полную версию.

## <a name="how-to-build-the-sample-using-visual-studio"></a>Способы создания образца с использованием Visual Studio.

1. Откройте проводник Windows и перейдите в каталог GetProcessSample05 в каталоге примеров.

   С помощью Windows PowerShell 2.0 установлен пакет SDK перейдите к папке GetProcessSample05. Расположение по умолчанию — C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\GetProcessSample05.
...
3. В **построения** меню, выберите **построить решение**.
   ...
   Библиотека для образца будет располагаться в каталог \bin или \bin\debug по умолчанию.
...
- Указание позиции для параметров.

- Указание, что параметры могут использоваться входные данные из конвейера. Входные данные могут быть взяты из объекта или значение из свойства объекта, имя свойства совпадает с именем параметра.

- Объявление атрибута проверки для входного параметра.

- Обработка ошибок и исключений.

- Создание сообщений отладки.

## <a name="example"></a>Пример

В этом примере показано, как создать командлет, который отображает список указанных процессов.
