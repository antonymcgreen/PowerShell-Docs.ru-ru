...
- Определение класса поставщика, который обеспечивает [System.Management.Automation.Provider.Drivecmdletprovider](/dotnet/api/System.Management.Automation.Provider.DriveCmdletProvider) класса.

- Перезапись [System.Management.Automation.Provider.Drivecmdletprovider.Newdrive*](/dotnet/api/System.Management.Automation.Provider.DriveCmdletProvider.NewDrive) метод для поддержки создания новых дисков. (В этом примере показано, как добавлять динамические параметры для `New-PSDrive` командлет.)
...
В этом примере показано, как перезаписать [System.Management.Automation.Provider.Drivecmdletprovider.Newdrive*](/dotnet/api/System.Management.Automation.Provider.DriveCmdletProvider.NewDrive) и [System.Management.Automation.Provider.Drivecmdletprovider.Removedrive*](/dotnet/api/System.Management.Automation.Provider.DriveCmdletProvider.RemoveDrive)методы. Для данного примера поставщика при создании диска его сведения о соединении сохраняются в `AccessDBPsDriveInfo` объекта.
